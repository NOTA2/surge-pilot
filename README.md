...
같은 보고서에서 5분 상승폭 **+10%**와 **+12%**도 각자의 첫 충족 분봉으로 비교합니다. +8%는 넓은 관찰 신호, +10%는 강한 신호 후보입니다. 30거래일 일봉 분류에서 +10%는 사전 발견 244건(+8%의 262건), 일봉 20~49% 후보 경보 329건(+8%의 461건)이었습니다. 이 후보 1,055건 중 65건은 저장된 **장전 분봉에서 +50%**에 도달했으므로 보고서에 재분류 결과도 별도로 표시합니다. 재분류 후 +8%는 사전 발견 292/879건, +10%는 271/720건입니다. 이 비율은 장전에서만 +20%였던 종목이 후보 선정에서 빠질 수 있어 전체 시장 적중률이 아닙니다. 이미 살펴본 기간의 탐색 결과이며, 뒤 15일 비교도 독립 검증은 아닙니다. 추가 기간과 실시간 모의 관측 전에는 조건을 확정하지 않습니다.
